                ...
                <div class="card bg-white py-vh-3 rounded-5 shadow">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-sm-10">
                                ...
                                <form id="likeForm" action="/Readteracy/like-book/{{ $detail_book->id }}" method="post">
                                    @csrf
                                    @if ($like && $detail_book->likers->contains(auth()->user()->id))
                                        <button id="likeButton" class="btn bg-warning mr-1 mt-3 mx-3" data-toggle="tooltip" name="is_like" title="Sukai buku" data-original-title="suka">
                                        ...
                                        <button id="likeButton" class="btn bg-warning mr-1 mt-3" data-toggle="tooltip" name="is_like" title="Sukai buku" data-original-title="suka">
