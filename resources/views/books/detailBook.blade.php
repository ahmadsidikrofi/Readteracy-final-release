                ...
                <div class="card bg-white py-vh-3 rounded-5 shadow">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-sm-10">
                                ...
                                <form id="likeForm" action="/Readteracy/like-dislike-book/{{ $detail_book->id }}" method="post">
                                    @csrf
                                    @if ($detail_book->likers->contains(auth()->user()->id))
                                        <button id="likeButton" class="bg-like mr-1 mt-3 mx-3" data-toggle="tooltip" name="is_like" title="Sukai buku" data-original-title="suka">
