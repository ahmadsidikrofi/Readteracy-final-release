    ...
    <body>
        <section class="mt-5">
            ...
            <div class="container w-50">
                <form action="/Readteracy/addGenre/store" method="post">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="">
                        <label for="nama_genre" class="form-label fw-bold fs-5">Nama Genre Baru</label>
                        <input type="text" name="nama_genre" class="form-control" id="nama_genre">
                    </div>
